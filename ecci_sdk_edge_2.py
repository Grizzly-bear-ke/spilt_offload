...
PUB_TARGETS = ast.literal_eval(os.getenv("ECCI_PUB_TARGETS",default = "{'cloud2': 'RANDOMSTRING'}" ))
...
CONTAINER_NAME = os.getenv("ECCI_CONTAINER_NAME", default="edge2")
BRIDGE_MOUNTPOINTS = ast.literal_eval(os.getenv("ECCI_BRIDGE_MOUNTPOINTS",default="[]"))

# ---------------------------任务3-4新增---------------------------
ECCI_APP_TYPE = os.getenv("ECCI_APP_TYPE", default="controller")  #controller/component
...
CONTAINER_TYPE = os.getenv("ECCI_CONTAINER_TYPE", default="cloud2")
        ...
        try:
            if targets == None:
                ...
                for target_item in target_list:
                    print("topic:", PUB_TOPICS[target_item])
