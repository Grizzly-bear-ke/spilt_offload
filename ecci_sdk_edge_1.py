...
PUB_TARGETS = ast.literal_eval(os.getenv("ECCI_PUB_TARGETS",default = "{'cloud1': 'RANDOMSTRING'}" ))
...
CONTAINER_NAME = os.getenv("ECCI_CONTAINER_NAME", default="edge1")
...
CONTAINER_TYPE = os.getenv("ECCI_CONTAINER_TYPE", default="cloud1")
